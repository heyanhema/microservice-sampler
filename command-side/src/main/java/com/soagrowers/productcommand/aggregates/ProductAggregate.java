 ...
 * it reacts to these com.soagrowers.product.commands it creates and 'applies'
 ...
 * <p/>
 * Axon delivers com.soagrowers.product.commands placed on the bus to the
 ...
 * EventHandlers.
 */
public class ProductAggregate extends AbstractAnnotatedAggregateRoot<String> {

	/**
	 * 
	 */
	private static final long serialVersionUID = -1483650340408836411L;
